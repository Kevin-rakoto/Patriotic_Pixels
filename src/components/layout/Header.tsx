...
const Header: FC<HeaderProps> = ({ activeHeading }) => {
  ...
  const [searchData, setSearchData] = useState<IProductData[] | null>(null);
  ...
  const handleSearchChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    const filteredProduct = productData.filter((product) =>
      product.name.toLowerCase().includes(term.toLocaleLowerCase())
    );
  ...
  return (
    <>
        ...
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          ...
          <div className="w-[50%] relative">
            <input
              ...
              className="h-[40px] w-full px-2 border-red-500 border-[2px] rounded-md"
            />
            <AiOutlineSearch
              size={30}
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-red-600 h-[70px]`}
      >
        <div
